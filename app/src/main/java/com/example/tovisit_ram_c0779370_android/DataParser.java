...
public class DataParser {
    ...
    private HashMap<String,String> getDuration(JSONArray directionJsonData) {
        HashMap<String,String> directionMMap = new HashMap<>();
        String duration = "";
        String distance = "";
        ...
        try {
            ...
            directionMMap.put("duration" ,duration);
            directionMMap.put("distance", distance);

        }catch  (JSONException e) {
            e.printStackTrace();
        }
        return  directionMMap;
    }
